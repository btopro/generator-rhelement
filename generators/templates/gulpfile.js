...
gulp.task("watch", () => {
  return gulp.watch("./src/*", gulp.series("merge", "mergees", "compile"));
});
...
gulp.task("default", gulp.series("merge", "mergees", "compile"));

gulp.task("dev", gulp.series("merge", "mergees", "compile", "watch"));
